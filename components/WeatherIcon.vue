<template>
  <div class="weather-icon" :class="`size-${size}`">
    ...
    <svg v-else-if="group === 8 && isDay" width="48" height="48" viewBox="-5 -5 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const group = computed(() => {
  ...
  if (code === '01') return 8
  if (code === '02') return 80
  if (code === '03' || code === '04' || code === '50') return 81
  if (code === '09' || code === '10') return 5
  if (code === '11') return 2
  if (code === '13') return 6
  return 81
})
